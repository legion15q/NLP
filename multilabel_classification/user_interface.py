...
def main():
    ...
    model_path = 'D:/BMSTU/Master/sem_3-4/НИР/py/multilabel_classification/sbert epoch = 1-val_loss = 0.6308-LR = 1.0e-06.pt'
    ...
    print(evaluate(model_path, input_sentence, input_entity))
    input_sentence = "К сожалению, Краснодар только однажды обыграл Зенит, но получил за это признание и фанатскую базу"
